...
const { loginHandler, logoutHandler } = require("./app/handlers/loginHandler");
...
const handlers = [loadResources(guestBookSrc), injectCookies, injectBodyParams, injectSession, loginHandler, logoutHandler, guestBookHandler(guestBookSrc, guestBook), apiHandler, serveFileContent, notFound];
